...
{
	// This code uses a geometry shader to create two triangles for each point "rendered"
	// by the shader. The code only "renders" one point, so the total number of triangles
